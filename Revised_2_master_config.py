  ...
  'neck pain': [
   ...
   'diarrhea': [
    ...
    'ear pain': [
        ...
        'soreness in ear cavity', 'clogged ear with pain', 'throbbing sensation in ear', 'ear ache during sleep', 'pain in eardrum', 'ear hurts'
    ],
    'back pain': [
    ...
    'knee pain': [
        ...
        'pain with knee instability','pain in knees','joint pain', 'pain from bursitis', 'pain with osteoarthritis', 'pain from cartilage damage', 'pain after knee surgery', 'pain in the back of the knee', 'pain in my knee', 'pain in my knees'
    ],
    'foot pain': [
