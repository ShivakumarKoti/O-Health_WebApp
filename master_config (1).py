  ...
  'back spasm': [
   ...
   'weakness': [
    ...
    'shortness of breath': [
        ...
        'lacking breath',"can’t breathe deeply", "can’t take my breath", "can’t breathe",'breathing rate is low', 'breathing rate is slow', 'dyspnea', 'trouble breathing', 'painful when breathing'
    ],
   'rapid breathing': [
