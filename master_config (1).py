...
symptom_synonyms = {
    ...
    'cough': [
        'Persistent cough', 'chronic cough', 'coughing','coughs', 'spasmodic cough', 'stubborn dry cough',
...
'kidney stone': ['kidney stone', 'kidney stones','stone in my stomach','stone in stomach','stone in kidney','stones in kidney','stone in the back','stones in the back','stones in my stomach','stones in stomach','stones in the stomach','stone in the stomach','stone in back', 
                 'there is a stone', 'there is stone','stone in stomach'],
...
symptom_followup_questions = {
  ...
  "stress": [
    ...
    },
    {
      ...
      "gu": "તમને પરિવાર અથવા મિત્રો તરફથી કેટલી મદદ મળે છે?",
      "te": "మీకు కుటుంబం లేదా స్నేహితుల నుండి ఎంతమాత్రం సహాయం/మద్దతు లభిస్తోంది?",
  ...
  "allergy": [
    ...
    {
      "hi": "क्या आप सामान्य रूप से खुद को एलर्जी से ग्रस्त महसूस करते हैं?",
      "en": "Do you generally feel that you suffer from allergies?",
      "gu": "સામાન્ય રીતે શું તમને લાગે છે કે તમે એલર્જીની સમસ્યાથી પીડિત છો?",
      "te": "సాధారణంగా మీరు అలర్జీలతో బాధపడుతున్నట్లు అనిపిస్తున్నదా?",
  ...
  "high blood pressure": [
    ...
    },
    {
      ...
      "gu": "શું તમારા પરિવાર માં હાઇ બ્લડ પ્રેશર, હૃદયરોગ અથવા સ્ટ્રોકનો ઈતિહાસ છે?",
      "te": "మీ కుటుంబంలో ఎవరైనా అధిక రక్తపోటు, గుండెజబ్బు లేదా స్ట్రోక్ సమస్యతో బాధపడ్డారా?",
  ...
  "gas": [
    ...
    },
    {
      ...
      "gu": "શું ગેસની સમસ્યાના કારણે તમારી ઊંઘ બગડતી હોય છે?",
      "te": "గ్యాస్ సమస్య వల్ల మీ నిద్రలో ఇబ్బంది కలుగుతోందా?",
      "category": "sleep issue",
      "symptom": "insomnia",
      "risk_factor": False,
    },
  ...
  "cold": [
    ...
    },
    {
      ...
      "gu": "શું તમને અચાનક જ ઘણું ઠંડું લાગવાનું શરૂ થયું?",
      "te": "మీకు అకస్మాత్తుగా చలి అనిపించడం మొదలైందా?",
      "category": "type: cold",
      "symptom": None,
      "risk_factor": False,
    },
  ...
  "memory loss": [
    ...
    },
    {
      ...
      "gu": "શું તમારા પરિવાર માં યાદશક્તિની તકલીફ અથવા નર્વસ સિસ્ટમની બીમારીઓ (જેમ કે અલ્ઝાઇમર, ડિમેન્શિયા)નો ઈતિહાસ છે?",
      "te": "మీ కుటుంబంలో ఎవరికైనా జ్ఞాపకశక్తి సమస్యలు లేదా నాడీ వ్యాధులు (అల్జీమర్స్, డిమెన్షియా వంటివి) ఉన్నాయా?",
  ...
  "tremor": [
    ...
    },
    {
      ...
      "gu": "શું કંપન તમારા શરીરના ચોક્કસ ભાગોમાં થાય છે (જેમ કે હાથ, માથું, અવાજ)?",
      "te": "మీ వణుకు శరీరంలోని ఏదైనా ప్రత్యేక భాగంలో (చేతులు, తల, గొంతు) వస్తుందా?",
    ...
    },
    {
      ...
      "gu": "શું તમારા પરિવારમાં કંપન અથવા ન્યુરોલોજિકલ બીમારીઓ (જેમ કે પાર્કિન્સન્સ રોગ)નો ઈતિહાસ છે?",
      "te": "మీ కుటుంబంలో వణుకు లేదా నాడీ సంబంధిత వ్యాధులు (ఉదా: పార్కిన్సన్ వ్యాధి) ఉన్నాయా?",
  ...
  "panic attack": [
    ...
    },
    {
      ...
      "te": "మీరు ప్రిస్క్రిప్షన్, ఓవర్-ది-కౌంటర్ మందులు లేదా హర్బల్ సప్లిమెంట్లు ఏవైనా తీసుకుంటున్నారా?",
  ...
  "loss of appetite": [
    ...
    },
    {
      ...
      "gu": "શું તમને થાયરોઇડ જેવી હોર્મોનલ તકલીફ છે?",
      "te": "మీకు థైరాయిడ్ వ్యాధి వంటి హార్మోన్ సమస్యలున్నాయా?",
      "category": "thyroid",
      "symptom": "thyroid",
      "risk_factor": True,
    },
  ...
  "asthma": [
    {
      "hi": "क्या आपके परिवार में किसी को अस्थमा है?",
      "en": "Do you have a family history of asthma?",
      "gu": "શું તમારા પરિવારમાં અસ્થમા નો ઈતિહાસ છે?",
      "te": "మీ కుటుంబంలో ఆస్తమా చరిత్ర ఉందా?",
      "category": "family history: asthma",
      "symptom": None,
      "risk_factor": True,
    },
...
"obesity": [
  ...
  },
  {
    ...
    "gu": "શું તમારા પરિવારના અન્ય સભ્યોને પણ મોટાપાની સમસ્યા છે?",
    "te": "మీ కుటుంబంలోని మరికొందరు కూడా ఊబకాయం సమస్యతో బాధపడుతున్నారా?",
    "category": "obesity",
    "symptom": None,
    "risk_factor": True
  },
...
"seizures": [
  ...
  },
  {
    ...
    "gu": "શું તમારા પરિવારના અન્ય કોઈ સભ્યને પણ દોરા (seizures) આવવાનો ઇતિહાસ છે?",
    "te": "మీ కుటుంబంలో మరెవరైనా సీజ్‌ల సమస్యతో బాధపడిన చరిత్ర ఉందా?",
    "category": "seizures",
    "symptom": None,
    "risk_factor": True
  },
...
"malaria": [
  ...
  },
  {
    ...
    "gu": "શું તમારા પરિવારમાં અન્ય કોઈને મલેરિયાનો ઇતિહાસ છે?",
    "te": "మీ కుటుంబంలో మరెవరైనా మలేరియా వచ్చిన చరిత్ర ఉందా?",
...
"urine issue": [
  {
    ...
    "en": "Do you feel a burning sensation or pain while urinating?",
    "gu": "મૂત્ર કરતી વખતે શું તમને દાઝ/જલન કે દુખાવો થાય છે?",
    "te": "మూత్రం పోయేటప్పుడు మండటం లేదా నొప్పి అనిపిస్తున్నదా?",
    "category": "pain: urination",
    "symptom": None,
    "risk_factor": False
  ...
  },
  {
    ...
    "gu": "શું તમારા મૂત્રમાંથી તીવ્ર અથવા અજાણી દુર્ગંધ આવે છે?",
    "te": "మీ మూత్రానికి బలమైన లేదా విచిత్రమైన వాసన ఉందా?",
    "category": "urine odor",
    "symptom": None,
    "risk_factor": False
  },
  {
    ...
    "gu": "શું તમે તમારા મૂત્રમાં લોહી જોયું છે?",
    "te": "మీ మూత్రంలో రక్తం కనిపించిందా?",
  ...
  },
  {
    ...
    "gu": "શું તમે તાજેતરમાં ઓછું પાણી અથવા દ્રવ લેતા હો?",
    "te": "ఇటీవల మీరు తగినంతగా నీరు/పానీయాలు తాగట్లేదా?",
    "category": "dehydration",
    "symptom": None,
    "risk_factor": True
  },
  {
    ...
    "gu": "શું તમને વારંવાર મૂત્ર કરવાની ઇચ્છા થાય છે પરંતુ દરેક વખતે થોડું જ મૂત્ર થાય છે?",
    "te": "మూత్రం తరచుగా పోవాలనిపించి, కానీ ప్రతి సారి కొద్దిగా మాత్రమే రావడమా?",
...
"male reproductive issues": [
  ...
  },
  {
    ...
    "gu": "શું તમારા પરિવારમાં પ્રજનન સંબંધિત સમસ્યાઓનો ઇતિહાસ છે?",
    "te": "మీ కుటుంబంలో ఎవరికైనా ప్రजनన సంబంధిత సమస్యల చరిత్ర ఉందా?",
    "category": "male_reproductive_issues",
    "symptom": "family history",
    "risk_factor": True
  }
...
"female reproductive issues": [
  ...
  },
  {
    ...
    "gu": "શું તમારા પરિવારમાં પ્રજનન આરોગ્ય સંબંધિત સમસ્યાઓનો ઇતિહાસ છે?",
    "te": "మీ కుటుంబంలో ప్రजनన సంబంధిత సమస్యల చరిత్ర ఉందా?",
    "category": "female_reproductive_issues",
    "symptom": None,
    "risk_factor": True
  },
...
"operation": [
  {
    ...
    "gu": "ઑપરેશન ક્યારે થયું હતું?",
    "te": "ఆపరేషన్ ఎప్పుడు జరిగింది?",
  ...
  },
  {
    ...
    "gu": "શું ઑપરેશન પછી તમને કોઈ તકલીફ અથવા ઇન્ફેક્શન થયું છે?",
    "te": "ఆపరేషన్ తర్వాత మీకు ఏదైనా అసౌకర్యం లేదా ఇన్‌ఫెక్షన్ వచ్చిందా?",
