...
symptom_list = [
    ...
    'thirsty', 'dehydration', 'skin burn', 'sweating', 'feeling cold', 'feeling hot',
    'head pressure', 'blurred vision', 'double vision', 'eye pain', 'eye redness',
    'eye discharge', 'ear discharge', 'hearing loss', 'ringing in ears',
    'balance problems', 'taste changes', 'smell changes', 'difficulty breathing',
    'rapid breathing', 'slow breathing', 'shortness of breath', 'breathing difficulty',
    'palpitations', 'irregular heartbeat', 'chest tightness', 'chest heaviness',
    'squeezing chest', 'sharp chest pain', 'burning chest pain', 'crushing chest pain',
    'tightness in chest', 'lightheadedness', 'fainting',
    'feeling faint', 'unsteady gait', 'clumsiness', 'loss of coordination',
    'seizures', 'convulsions', 'tremors', 'shakiness', 'nervousness', 'panic attacks',
    'mood swings', 'irritability', 'agitation', 'restlessness', 'confusion',
    'memory problems', 'difficulty concentrating', 'foggy mind', 'hallucinations',
    'delusions', 'paranoia', 'euphoria', 'apathy', 'lack of motivation',
    'social withdrawal', 'anhedonia', 'exhaustion', 'muscle weakness',
    'muscle cramps', 'muscle stiffness', 'joint stiffness', 'joint swelling',
    'joint redness', 'joint warmth', 'joint tenderness', 'bone pain',
    'bone fractures', 'fractures', 'sprains', 'strains', 'ligament injuries',
    'tendonitis', 'bursitis', 'arthritis', 'osteoarthritis', 'rheumatoid arthritis',
    'gout', 'fibromyalgia', 'sciatica', 'herniated disc', 'spinal stenosis',
    'back spasms', 'neck pain', 'whiplash', 'carpal tunnel syndrome',
    'tenosynovitis', 'sinus pressure', 'sinus headache', 'sore muscles',
    'muscle spasms', 'muscle injuries', 'skin rashes', 'eczema', 'psoriasis',
    'hives', 'urticaria', 'contact dermatitis', 'atopic dermatitis',
    'seborrheic dermatitis', 'cutaneous lupus', 'skin infections', 'cellulitis',
    'impetigo', 'herpes', 'shingles', 'warts', 'moles', 'skin lesions',
    'skin lumps', 'skin bumps', 'skin discoloration', 'skin dryness',
    'skin peeling', 'skin cracking', 'skin itching', 'skin burning',
    'skin pain', 'skin tenderness', 'skin redness', 'skin swelling',
    'skin blisters', 'skin ulcers', 'skin sores', 'skin growths',
    'skin changes', 'hair thinning', 'hair breakage', 'hair brittleness',
    'hair loss patterns', 'hair shedding', 'hair graying', 'hair texture changes',
    'hair color changes', 'hair growth abnormalities', 'hair density changes',
    'hair quality changes', 'nail discoloration', 'nail brittleness',
    'nail separation', 'nail ridges', 'nail pitting', 'nail thickening',
    'nail splitting', 'nail fragility', 'nail ulcers', 'nail pain',
    'nail deformation', 'nail lesions', 'nail abnormalities', 'nail fungus',
    'nail psoriasis', 'nail lichen planus', 'nail melanonychia',
    'nail leukonychia', 'nail onychomycosis', 'nail paronychia',
    'nail green nail syndrome', 'nail clubbing', 'nail concave nails',
    'nail convex nails', 'nail horizontal ridges', 'nail vertical ridges',
    'nail spoon nails', 'nail koilonychia', 'nail trachyonychia',
    'nail dystrophy', 'nail redness', 'nail swelling', 'nail discoloration',
    'headache types', 'throat irritation', 'ear pain', 'sinus congestion',
    'abdominal bloating', 'stomach discomfort', 'intestinal gas',
    'belching', 'heart palpitations', 'rapid heartbeat', 'slow heartbeat',
    'arrhythmia', 'angina', 'heart murmur', 'heart flutter', 'cardiac arrest',
    'cardiovascular issues', 'respiratory distress', 'asthma attacks',
    'bronchitis', 'pneumonia', 'emphysema', 'COPD', 'pulmonary fibrosis',
    'lung infection', 'chest congestion', 'wheezing sounds', 'coughing fits',
    'persistent cough', 'dry cough', 'productive cough', 'cough with phlegm',
    'cough with blood', 'night cough', 'daytime cough', 'coughing up mucus',
    'coughing up blood', 'sore muscles', 'muscle aches', 'muscle soreness',
    'muscle fatigue', 'muscle inflammation', 'muscle rigidity',
    'muscle cramps', 'muscle spasms', 'joint stiffness', 'joint inflammation',
    'joint tenderness', 'joint swelling', 'joint redness', 'joint warmth',
    'joint pain on movement', 'joint pain at rest', 'joint locking',
    'joint clicking', 'joint instability', 'joint deformity', 'bone pain during movement',
    'bone pain at rest', 'bone swelling', 'bone tenderness', 'fracture pain',
    'fracture swelling', 'fracture tenderness', 'sprain pain', 'sprain swelling',
    'strain pain', 'strain swelling', 'ligament tear pain', 'ligament tear swelling',
    'tendonitis pain', 'tendonitis swelling', 'bursitis pain', 'bursitis swelling',
    'arthritis pain', 'arthritis stiffness', 'arthritis swelling', 'osteoarthritis pain',
    'rheumatoid arthritis pain', 'gout pain', 'fibromyalgia pain',
    'sciatica pain', 'herniated disc pain', 'spinal stenosis pain',
    'back spasm pain', 'neck pain from whiplash', 'carpal tunnel pain',
    'tenosynovitis pain', 'sinus pressure headache', 'sinus congestion headache',
    'sore muscle pain', 'muscle spasm pain', 'skin rash itching',
    'eczema flare-up', 'psoriasis plaque', 'hives welts', 'urticaria swelling',
    'contact dermatitis rash', 'atopic dermatitis flare-up',
    'seborrheic dermatitis scaling', 'cutaneous lupus rash',
    'skin cellulitis pain', 'impetigo sores', 'herpes blisters',
    'shingles pain', 'wart growth', 'mole changes', 'skin lesion growth',
    'skin lump swelling', 'skin bump pain', 'skin discoloration patches',
    'skin dryness scales', 'skin peeling flaking', 'skin cracking fissures',
    'skin itching severity', 'skin burning sensation',
    'skin pain sensitivity', 'skin tenderness swelling',
    'skin redness inflammation', 'skin swelling puffiness',
    'skin blister formation', 'skin ulcer formation', 'skin sore pain',
    'skin growth development', 'skin change patterns',
    'hair thinning severity', 'hair breakage extent',
    'hair brittleness fragility', 'hair loss patterns',
    'hair shedding rate', 'hair graying progression',
    'hair texture changes roughness', 'hair color changes fading',
    'hair growth abnormalities', 'hair density changes',
    'hair quality changes softness', 'nail discoloration yellowing',
    'nail brittleness fragility', 'nail separation from nail bed',
    'nail ridges depth', 'nail pitting spots', 'nail thickening hardness',
    'nail splitting length', 'nail fragility breakage', 'nail ulcers depth',
    'nail pain sensitivity', 'nail deformation shape',
    'nail lesions spots', 'nail abnormalities shape',
    'nail fungus discoloration', 'nail psoriasis scaling',
    'nail lichen planus patches', 'nail melanonychia brown streaks',
    'nail leukonychia white spots', 'nail onychomycosis fungal infection',
    'nail paronychia inflammation', 'nail green nail syndrome discoloration',
    'nail clubbing shape changes', 'nail concave nails scooping',
    'nail convex nails doming', 'nail horizontal ridges lines',
    'nail vertical ridges lines', 'nail spoon nails concave shape',
    'nail koilonychia spoon-shaped nails', 'nail trachyonychia rough nails',
    'nail dystrophy irregular nails', 'nail redness inflammation',
    'nail swelling puffiness', 'nail discoloration yellowing',
    'nail abnormalities structural changes',
    'headache intensity mild', 'headache intensity moderate',
    'headache intensity severe', 'headache location frontal',
    'headache location temporal', 'headache location occipital',
    'headache location parietal', 'headache duration short',
    'headache duration long', 'headache frequency occasional',
    'headache frequency frequent', 'headache associated with nausea',
    'headache associated with sensitivity to light',
    'headache associated with sensitivity to sound',
    'headache accompanied by vomiting', 'headache accompanied by dizziness',
    'throat irritation dryness', 'throat irritation soreness',
    'ear pain sharp', 'ear pain dull', 'sinus congestion pressure',
    'abdominal bloating sensation', 'stomach discomfort ache',
    'intestinal gas flatulence', 'belching frequent', 'heart palpitations irregular',
    'rapid heartbeat racing', 'slow heartbeat bradycardia',
    'arrhythmia irregular rhythm', 'angina chest discomfort',
    'heart murmur abnormal sound', 'heart flutter rapid beats',
    'cardiac arrest sudden stop', 'cardiovascular issues general',
    'respiratory distress acute', 'asthma attacks severe', 'bronchitis chronic',
    'pneumonia bacterial', 'emphysema chronic', 'COPD obstructive',
    'pulmonary fibrosis scarring', 'lung infection acute', 'chest congestion tightness',
    'wheezing sounds high-pitched', 'coughing fits uncontrollable',
    'persistent cough long-lasting', 'dry cough non-productive',
    'productive cough with phlegm', 'cough with blood hemoptysis',
    'night cough nocturnal', 'daytime cough frequent', 'coughing up mucus',
    'coughing up blood hemoptysis', 'sore muscles generalized',
    'muscle aches soreness', 'muscle soreness discomfort', 'muscle fatigue extreme',
    'muscle inflammation redness', 'muscle rigidity stiffness', 'muscle cramps painful',
    'muscle spasms involuntary', 'joint stiffness restricted movement',
    'joint inflammation swelling', 'joint tenderness sensitive',
    'joint swelling puffiness', 'joint redness erythema',
    'joint warmth heat', 'joint pain on movement active', 'joint pain at rest passive',
    'joint locking inability to move', 'joint clicking clicking sounds',
    'joint instability wobbling', 'joint deformity malformation',
    'bone pain during movement', 'bone pain at rest', 'bone swelling swelling',
    'bone tenderness sensitive', 'fracture pain severe', 'fracture swelling swollen',
    'fracture tenderness tender', 'sprain pain mild', 'sprain swelling mild',
    'strain pain moderate', 'strain swelling moderate', 'ligament tear pain',
    'ligament tear swelling', 'tendonitis pain chronic', 'tendonitis swelling',
    'bursitis pain bursae inflammation', 'bursitis swelling bursae swelling',
    'arthritis pain chronic', 'arthritis stiffness chronic', 'arthritis swelling',
    'osteoarthritis pain degenerative', 'rheumatoid arthritis pain autoimmune',
    'gout pain severe', 'fibromyalgia pain widespread', 'sciatica pain nerve',
    'herniated disc pain spinal', 'spinal stenosis pain spinal', 'back spasm pain acute',
    'neck pain cervical', 'whiplash neck injury', 'carpal tunnel pain wrist',
    'tenosynovitis pain tendon sheath', 'sinus pressure headache facial',
    'sinus congestion headache facial', 'sore muscle pain generalized',
    'muscle spasm pain involuntary', 'skin rash itching pruritus',
    'eczema flare-up dermatitis', 'psoriasis plaque scaling',
    'hives welts urticaria', 'urticaria swelling wheals',
    'contact dermatitis rash allergic', 'atopic dermatitis flare-up chronic',
    'seborrheic dermatitis scaling dandruff', 'cutaneous lupus rash autoimmune',
    'skin cellulitis pain bacterial', 'impetigo sores contagious',
    'herpes blisters viral', 'shingles pain viral', 'wart growth viral',
    'mole changes skin', 'skin lesion growth abnormal', 'skin lump swelling',
    'skin bump pain raised', 'skin discoloration patches hyperpigmentation',
    'skin dryness scales', 'skin peeling flaking', 'skin cracking fissures',
    'skin itching severity intense', 'skin burning sensation painful',
    'skin pain sensitivity hypersensitive', 'skin tenderness swelling',
    'skin redness inflammation erythema', 'skin swelling puffiness',
    'skin blister formation fluid-filled', 'skin ulcer formation open sores',
    'skin sore pain painful', 'skin growth development abnormal', 'skin change patterns varied',
    ...
    'hair growth abnormalities abnormal', 'hair density changes low',
    'hair density changes high', 'hair quality changes soft',
    'hair quality changes brittle', 'nail discoloration yellowing',
    'nail discoloration white spots', 'nail discoloration brown streaks',
    'nail brittleness fragility', 'nail separation from nail bed',
    'nail ridges depth pronounced', 'nail pitting spots scattered',
    'nail thickening hardness hard', 'nail splitting length splitting',
    'nail fragility breakage easy', 'nail ulcers depth deep',
    'nail pain sensitivity painful', 'nail deformation shape distorted',
    'nail lesions spots raised', 'nail abnormalities shape irregular',
    'nail fungus discoloration green', 'nail psoriasis scaling',
    'nail lichen planus patches flat', 'nail melanonychia brown streaks',
    'nail leukonychia white spots', 'nail onychomycosis fungal infection',
    'nail paronychia inflammation around nail',
    'nail green nail syndrome discoloration green', 'nail clubbing shape changes',
    'nail concave nails scooping', 'nail convex nails doming',
    'nail horizontal ridges lines', 'nail vertical ridges lines',
    'nail spoon nails concave shape', 'nail koilonychia spoon-shaped nails',
    'nail trachyonychia rough nails', 'nail dystrophy irregular nails',
    'nail redness inflammation', 'nail swelling puffiness',
    'nail discoloration yellowing', 'nail abnormalities structural changes',
    'headache intensity mild', 'headache intensity moderate',
    'headache intensity severe', 'headache location frontal',
    'headache location temporal', 'headache location occipital',
    'headache location parietal', 'headache duration short',
